...
static let receipesData: [Recipe] = [
    ...
    Recipe(id: UUID(), name: "Pani Puri", image: "paani puri",category: "Drinks", cookingTime: 20, instructions:"Rinse 1 cup tightly packed coriander leaves, ½ cup tightly packed mint leaves, 2 to 3 green chilies and 1 inch ginger very well in water a few times. Drain all the water.Peel the ginger and roughly chop it. Also chop the green chilies. Roughly chop the coriander leaves and mint leaves. Don’t use the stem of mint leaves as they can make the spiced water have a bitter taste. Only use the fresh mint leaves.",
